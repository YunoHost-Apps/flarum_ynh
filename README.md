...
## Post-installation
Post-installation is not automated.
...
2. Go to your Flarum homepage to initiate post-installation.

3. Fill in the blanks about `MySQL` as follow, put the retrieved database password. The remaining blanks are up to you.

<p align="center"><img src="http://i.imgur.com/p7XmTDw.png" width="500" ></p>
